...
const serviceAccount = require('./larabase-2267e-firebase-adminsdk-i2i5o-2808f63f1f.json');
...
const auth = new google.auth.GoogleAuth({
  keyFile: "./rfidtelyu-1833bc1f2ba7.json", // Path to your service account JSON file
